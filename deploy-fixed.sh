...
# Script de despliegue corregido para EC2 Ubuntu
set -e
...
echo "🚀 Despliegue corregido en EC2 Ubuntu..."
...
run_remote "sudo apt remove -y nodejs npm || true"
run_remote "sudo apt autoremove -y"

echo "🔧 Instalando Node.js correctamente..."
